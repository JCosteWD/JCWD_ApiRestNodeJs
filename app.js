...
// Installation de la librairie "cors" afin de mettre l'api aux normes cors et de sécuriser considérablement mes requetes 
...
app
    ...
    .use(bodyParser.json())
    .use(cors())
        /* Possiblité de rajouter un certains nombre d'option au middleware "cors"
